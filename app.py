...
lineaccesstoken = 'xq44b+HDCbm3zDm4vRJl2Tl8DWvb/WQZoPMUPqUAAECL3ZflrRw4Nr9aaASUUJGpv3ZWBSH2xkHS6B76/fqEtP9NdBp9XqTSESGBfAhdx15jVu7zxwpJZsutJYVlCrdZBS4HvsEX8UoEsmi3VHviMwdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี" : 
            ...
            replyObj = TextSendMessage(text="กินๆ")
            line_bot_api.reply_message(rtoken, replyObj)
            ...
            url = "https://bots.dialogflow.com/line/89c06d0a-c442-4e6c-a5c8-54c131afefa1/webhook"
            https://dialogflow.cloud.google.com/v1/integrations/line/webhook/89c06d0a-c442-4e6c-a5c8-54c131afefa1
